...
import { MapPin, Plus, Calendar, ArrowRight, Building2, Share2, Edit, Trash2, ArrowLeft } from "lucide-react"
...
const VenueSelectionPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {venues.map((venue) => {
                ...
                return (
                  <div
                    key={venue.id}
                    className="bg-white border border-slate-200 rounded-2xl overflow-hidden hover:shadow-lg hover:border-slate-300 transition-all duration-200 group"
                  >
                    {/* Header Section */}
                    <div className="relative h-32 bg-slate-100 flex items-center justify-center">
                      ...
                      <div className="absolute top-3 right-3 flex gap-2">
                        <button
                          ...
                          className="p-2 bg-white/95 hover:bg-blue-50 rounded-lg shadow-sm border border-white/20 transition-all duration-200 group"
                        >
                        ...
                        <button
                          ...
                          className="p-2 bg-white/95 hover:bg-red-50 rounded-lg shadow-sm border border-white/20 transition-all duration-200"
                        >
                    ...
                    <div className="p-5">
                      ...
                      <Button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-3 rounded-xl font-medium transition-all duration-200"
                      >
      ...
      {/* Delete Confirmation */}
      {showDelete && venueToDelete && (
        <DeletePopup
          open={showDelete}
          title="Delete Venue"
          description={`Are you sure you want to delete "${venueToDelete.name}"? This action cannot be undone.`}
